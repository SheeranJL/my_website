    ...
    return (
      ...
      <div className='project-page-container'>
        ...
        <div className='project-item-container'>
          { projectPlacements.map((project, index) => <ProjectDisplay title={project.title} link={project.link} description={project.description} image={project.image} setDisplayModal={setDisplayModal} blurb={project.blurb} stack={project.stack}/>) }
        </div>
